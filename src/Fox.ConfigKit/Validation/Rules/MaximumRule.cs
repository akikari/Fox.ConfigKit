//==================================================================================================
// Validation rule that ensures a comparable value is at most a maximum value.
// Sealed class implementation for maximum value validation with inclusive bound.
//==================================================================================================
...
//==================================================================================================
/// <summary>
/// Validates that a comparable value is less than or equal to a specified maximum.
/// </summary>
...
//==================================================================================================
internal sealed class MaximumRule<T, TValue>(Expression<Func<T, TValue>> selector, TValue maximum, string? customMessage = null) : ValidationRuleBase, IValidationRule<T> where T : class where TValue : IComparable<TValue>
{
    #region Fields
    ...
    public ConfigValidationError? Validate(T options, string sectionName)
    {
        ...
        if (value.CompareTo(maximum) > 0)
        {
            ...
            var message = customMessage ?? $"{propertyName} must be at most {maximum} (current: {value})";
