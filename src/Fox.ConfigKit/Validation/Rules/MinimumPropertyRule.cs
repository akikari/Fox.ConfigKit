//==================================================================================================
// Validation rule that compares two properties ensuring one is at least the other.
// Sealed class implementation for property-to-property comparison with inclusive bound.
//==================================================================================================
...
//==================================================================================================
/// <summary>
/// Validates that one property value is greater than or equal to another property value.
/// </summary>
...
//==================================================================================================
internal sealed class MinimumPropertyRule<T, TValue>(Expression<Func<T, TValue>> selector, Expression<Func<T, TValue>> compareToSelector, string? customMessage = null) : ValidationRuleBase, IValidationRule<T> where T : class where TValue : IComparable<TValue>
{
    #region Fields
    ...
    public ConfigValidationError? Validate(T options, string sectionName)
    {
        ...
        if (value.CompareTo(compareToValue) < 0)
        {
            ...
            {
                $"{propertyName} must be at least {compareToPropertyName}",
