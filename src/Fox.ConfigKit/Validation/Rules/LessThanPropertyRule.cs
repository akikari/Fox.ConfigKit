//==================================================================================================
// Validation rule that compares two properties ensuring one is less than the other.
...
//==================================================================================================
/// <summary>
/// Validates that one property value is less than another property value.
/// </summary>
...
//==================================================================================================
internal sealed class LessThanPropertyRule<T, TValue>(Expression<Func<T, TValue>> selector, Expression<Func<T, TValue>> compareToSelector, string? customMessage = null) : ValidationRuleBase, IValidationRule<T> where T : class where TValue : IComparable<TValue>
{
    #region Fields
    ...
    public ConfigValidationError? Validate(T options, string sectionName)
    {
        ...
        if (value.CompareTo(compareToValue) >= 0)
        {
            ...
            {
                $"{propertyName} must be less than {compareToPropertyName}",
